...
const topicPool = [
  ...
  "the Pre-Raphaelites staging a Victorian art world rebellion against academic painting",
  "Duchamp's urinal as the most subversive artwork in Western art history",
  "the Elgin Marbles controversy that has divided nations for two centuries",
  "Rembrandt's bankruptcy and how he painted his greatest works while deeply in debt",
  "how cave paintings at Chauvet were created 36000 years ago with surprisingly sophisticated technique",
  ...
  "how Andy Warhol turned commercial imagery into high art and permanently changed what art means",
  "the long controversy over which Renaissance paintings are genuine Michelangelos",
  "how Islamic geometric art encodes mathematical structures that tile without repeating",
  "the story of Artemisia Gentileschi painting revenge on her rapist through biblical scenes",
  "how the Bayeux Tapestry is technically embroidery not tapestry and was Norman propaganda",
  "how Pointillism emerged from a scientific theory of color perception",
  "the rediscovery of medieval manuscript illumination as one of history's most labor-intensive art forms",
